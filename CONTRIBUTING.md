...
jekyll-netlify-headers is written in [Ruby](https://www.ruby-lang.org) (version 2.4.7) and development dependencies are managed using the [Bundler](https://bundler.io) gem.
